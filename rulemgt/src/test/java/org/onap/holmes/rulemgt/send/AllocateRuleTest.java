...
public class AllocateRuleTest {

    private AllocateRule allocateRule = new AllocateRule();
    ...
    public void extendCompareIpTest() throws Exception{
        ...
        List<String> extendIp = Whitebox.invokeMethod(allocateRule,"extendCompareIp",newList,oldList);
    ...
    public void destroyCompareIpTest() throws Exception{
        ...
        List<String> destoryIp = Whitebox.invokeMethod(allocateRule,"destroyCompareIp",newList,oldList);
