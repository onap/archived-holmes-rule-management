...
import org.onap.holmes.rulemgt.send.AllocateRule;
...
public class MsbQuery {
    ...
    @Inject
    private AllocateRule allocateRule;
    ...
    public void timer() throws Exception{
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                try {
                    timerIpList = getEngineIp.getServiceCount();
                    getEngineIp4AddRule.getIpList(timerIpList);
                    allocateRule.judgeAndAllocateRule(timerIpList);
